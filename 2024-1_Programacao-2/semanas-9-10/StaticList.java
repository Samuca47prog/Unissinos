...
public class StaticList<E> implements List<E> {
	...
	/**
	 * Retorna a quantidade de vezes que um dado elemento foi encontrado na lista.
	 * @param el elemento a ser contabilizado
	 */
	...
	private int contaElementos(E el, int i, int cont){
		if(i > numElements()) 
			return cont;
		...
		return contaElementos(el, i+1, cont);
	}
}