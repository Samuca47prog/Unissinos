public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		Cosmetico lojaCosmetico;
		Vestuario lojaVestuario;
		Bijuteria lojaBijuteria;
		Alimentacao lojaAlimentacao;
		Informatica lojaInformatica;
		 ...
		 **********************************************/
		{
			System.out.println("\n\t Verificações da Classe Endereco");

			//instância
			e1 = new Endereco("Rua dos Bobos", "Piraporinha", "SC", "Uruguai", "99000-100", "0", "Fundos");
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Data");

			//instância
			d1 = new Data(10, 3, 2023);
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Produto");

			p1 = new Produto("Cubo mágico", 10.0, d1);
			System.out.println("[OK] Classe Produto identificada");
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Loja");

			loja1 = new Loja ("E3", 5, e1, d1, 5);
			System.out.println("[OK] Classe Loja identificada (construtor com cinco parâmetros)");
			
			loja2 = new Loja ("E7", 20, 2000.0, e1, d1, 2);
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Cosmético");

			//Criação da instância
			lojaCosmetico = new Cosmetico("Loja Cosmético", 10, 2100.0, e1, d1, 20, 10);
			System.out.println("[OK] Classe Cosmetico identificada");
		...
		/**********************************************
		 Verificação da classe Vestuário
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Vestuário");
			//Criação da instância
			lojaVestuario = new Vestuario("Loja Vestuário", 10, 2100.0, e1, d1, false, 10);
			System.out.println("[OK] Classe Vestuario identificada");
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Bijuteria");

			//Criação da instância
			lojaBijuteria = new Bijuteria("Loja Bijuteria", 10, 2100.0, e1, d1, 5000.0, 10);
			System.out.println("[OK] Classe Bijuteria identificada");
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Alimentacao");

			//Criação da instância
			lojaAlimentacao = new Alimentacao("Loja Alimentação", 10, 2100.0, e1, d1, d1, 10);
			System.out.println("[OK] Classe Alimentacao identificada");
		...
		/**********************************************
		 Verificação da classe Informática
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Informática");

			//// Verificação da classe Informatica
			//Criação da instância
			lojaInformatica = new Informatica("Loja Informática", 10, 2100.0, e1, d1, 300, 10);
			System.out.println("[OK] Classe Informatica identificada");
		...
		**********************************************/
		{
			System.out.println("\n\t Verificações da Classe Shopping");

			shopping = new Shopping("Shopping Real", e1, 2);
			System.out.println("[OK] Classe Shopping idetificada");
